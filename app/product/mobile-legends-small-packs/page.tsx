...
export default function MobileLegendsSmallPacksPage() {
  ...
  useEffect(() => {
    const productRef = doc(db, "products", "mobile-legends-small-packs");
    ...
    return onSnapshot(
      ...
      (error) => {
        console.error("Failed to load MLBB Small Packs product:", error);
        setLoading(false);
      }
    );
  }, []);

  const packages = product?.categories?.Diamonds ?? [];
      ...
      <div className="max-w-md mx-auto pb-10">
        ...
        <div className="relative">
          ...
          <div className="absolute bottom-5 left-5">
            <h1 className="text-3xl font-extrabold">{product.name || "MLBB Small Packs"}</h1>

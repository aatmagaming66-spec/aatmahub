...
export default function MobileLegendsPhilippinesPage() {
  ...
  useEffect(() => {
    const productRef = doc(db, "products", "mobile-legends-ph");
    ...
    return onSnapshot(
      ...
      (error) => {
        console.error("Failed to load Mobile Legends Philippines product:", error);
        setLoading(false);
      }
    );
  }, []);
      ...
      <div className="max-w-md mx-auto pb-10">
        ...
        <div className="relative">
          <Image
            ...
            alt="Mobile Legends Philippines"
            width={1200}
            height={450}
            priority
            ...
            onClick={async () => {
              ...
              try {
                ...
                const response = await fetch(
                  `/api/smile-ph/get-role?userid=${encodeURIComponent(
                    playerId.trim()
              ...
              >
                ...
                <div className="mt-0 flex items-end justify-between">
                  <img
                    src={
                      activeTab === "Diamonds"
                        ? pkg.name === "6042 Diamonds"
                          ? "/images/5532-9288 diamonds.png"
                          : pkg.name === "1163 Diamonds" ||
                              pkg.name === "2398 Diamonds"
                            ? "/images/2195-3688 diamonds.png"
                            : pkg.name === "223 Diamonds" ||
                                pkg.name === "336 Diamonds" ||
                                pkg.name === "570 Diamonds"
                              ? "/images/514 diamonds.png"
                              : "/images/86 diamonds.png"
                        : activeTab === "Passes"
                          ? pkg.name === "Twilight Pass" ? "/images/ml gifting.png" : "/images/weekly pass.png"
                          : activeTab === "Special Bundle"
                            ? "/images/bundle tabs.png"
                            : "/images/special tabs.png"
                    }
                    alt={pkg.name}

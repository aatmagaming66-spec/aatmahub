...
import { Plus, Edit2, Trash2, Loader2, Search, Share2, Save, ImageIcon } from 'lucide-react';
...
export default function SocialManagementPage() {
  ...
  const { data: items, loading } = useCollection(query(collection(db, 'social_services'), orderBy('sortOrder', 'asc')));

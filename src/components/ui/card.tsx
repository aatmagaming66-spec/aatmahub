...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-2xl border bg-card text-card-foreground shadow-3d glass-elevated overflow-hidden",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("text-[10px] font-black uppercase tracking-widest text-muted-foreground opacity-60", className)}
    {...props}
  />
))

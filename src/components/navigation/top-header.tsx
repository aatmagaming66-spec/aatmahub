      ...
      <div className="flex h-full items-center justify-between px-4">
        ...
        <div className="flex items-center gap-1">
          <Link href="/cart" prefetch={false}>
            <Button variant="ghost" size="icon" className="h-10 w-10 rounded-full relative hover:bg-white/5 active-press">
          ...
          <Button variant="ghost" size="icon" className="h-10 w-10 rounded-full hover:bg-white/5 active-press">
          ...
          <Button 
            variant="ghost" 
            size="icon" 
            className="h-10 w-10 rounded-full hover:bg-white/5 active-press"

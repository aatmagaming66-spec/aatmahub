        ...
        <div className="space-y-3">
          <div className="flex justify-between items-end">
            <div className="space-y-0.5">
               <p className="text-[8px] font-black text-white/40 uppercase tracking-widest">Prestige Progress</p>
  ...
  return (
    <div className="space-y-3 animate-in slide-in-from-bottom-2 duration-700">
      <div className="flex items-center gap-2 px-1 mb-1">
        ...
        <span className="text-[8px] font-black uppercase tracking-widest text-white/40">Tier Benefits Overview</span>
      </div>

  ...
  return (
    <section className="px-4 py-1.5 relative z-30">
      <div className="grid grid-cols-4 gap-2">
        ...
        <Link href="/id-checker" className="flex flex-col items-center justify-center bg-card p-1.5 rounded-xl border border-border shadow-lg transition-all active:scale-95 hover:border-accent/30 group">
